...
function TextUpdaterNode({ isConnectable, onDragStart, draggable }) {
  const [text, setText] = useState('Business Application Application');
    ...
    <>
      ...
      <div className='custom-node'>
        <div className='toggle-shape' onDragStart={onDragStart} draggable={draggable} onDoubleClick={handleDoubleClick}>
          ...
          <AccessAlarmIcon className='icon-tu icon' />
        </div>
