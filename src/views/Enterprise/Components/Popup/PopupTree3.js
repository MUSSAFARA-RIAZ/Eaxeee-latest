            ...
            >
              <form>
                <TextField
                  name="fullName"
                  type="text"
                  label={(updateTreeState.action === "create meta-model" && type==="folder") ? "Folder name" : "Document name"}
                  autoComplete="off"
                  fullWidth
                  size="small"
                  ...
                  placeholder={(updateTreeState.action === "create meta-model" && type==="folder") ? "Folder name" : "Document name"}
                  required
