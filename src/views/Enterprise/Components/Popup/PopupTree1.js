...
const PopupTree1 = ({ handleClose, itemNameInput, setItemNameInput, updateTreeState, type, setSelectedFile, createNewFolder, createNewFile, closeCreateFolderModal, props }) => {
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}> {/* Flex for logo and title */}
              ...
              <Typography variant="h6">
                {(props.language === "en" && type==="folder") ? "Create Folder" : "Create Architecture"}
              </Typography>
            </Box>
            ...
            >
              <form>
                <TextField
                  name="fullName"
                  type="text"
                  label={(updateTreeState.action === "create meta-model" && type==="folder") ? "Folder name" : "Architecture name"}
                  autoComplete="off"
                  fullWidth
                  size="small"
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupTree1);