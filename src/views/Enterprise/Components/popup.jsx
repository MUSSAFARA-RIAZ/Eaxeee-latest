...
const Popup = ({ handleClose, itemNameInput, setItemNameInput, updateTreeState, type, setSelectedFile, createNewFolder, createNewFile, closeCreateFolderModal, props }) => {
