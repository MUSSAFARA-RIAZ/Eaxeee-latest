...
const StartShapeModal = ({ open, onClose, onSelect, handleClose, selectedLineStyle, theme, language }) => {
            ...
            >
                <Box sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Typography variant="h6">
                        {language === "en" ? "Select Start Shape" : AdminTranslation["Select Start Shape"]}
                    </Typography>
                </Box>
                <IconButton
                    sx={{
...
export default StartShapeModal;
