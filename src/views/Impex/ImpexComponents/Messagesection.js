...
export default function Messagesection({ props }) {
  ...
  return (
    ...
    >
      ...
      <div className={`${props.theme === "default"
          ? ImpexDefaultTheme.Impex_Messagesection
          : props.theme === "light"
            ? ImpexLightTheme.Impex_Messagesection
            : ImpexDarkTheme.Impex_Messagesection
        }`} >
        
        <p style={{ color: "white", fontSize: "20px", padding: "5px 10px" }}>
        
        Message
    
       <DownloadIcon sx={{float:"right",position:"relative",top:"5px"}}/>
       </p>
